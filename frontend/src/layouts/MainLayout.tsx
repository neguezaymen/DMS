...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Building2, labelKey: 'nav.departments', to: '/admin/departments', adminOnly: true },
      { icon: Sliders, labelKey: 'nav.settings', to: '/admin/settings', adminOnly: true },
      { icon: ListTree, labelKey: 'nav.customFields', to: '/admin/custom-fields', adminOnly: true },
    ],
  },
  {
    titleKey: 'nav.section.audit',
    items: [{ icon: History, labelKey: 'nav.auditLogs', to: '/audit-logs', adminOnly: true }],
  },
]
